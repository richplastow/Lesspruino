...
/*! Lesspruino 0.0.1 //// MIT Licence //// http://lesspruino.richplastow.com/ */
(function(global) {
...
/*! Lesspruino 0.0.1 */
var Lesspruino, SomeClass, Tudor, tudor, x, xx,
...
Lesspruino = (function() {
  ...
  Lesspruino.prototype.xx = function(yy) {
    var M;
...
SomeClass = (function() {
  ...
  function SomeClass(config) {
    ...
    M = '/lesspruino/src/SomeClass.litcoffee SomeClass()\n  ';
    v = oo.vObject(M, 'config', config);
    this.x = v('x <number>', 123);
    oo.define(this, oo._, {}, 'private');
    this[oo._]._x = null;
  ...
  SomeClass.prototype.xx = function(yy) {
    var M;
    M = '/lesspruino/src/SomeClass.litcoffee SomeClass::xx()\n  ';
    return yy = oo.vArg(M, yy, 'yy <number>', 123);
  };
...
SomeClass.FirstSubClass = (function(superClass) {
  ...
  function FirstSubClass(config) {
    ...
    M = '/lesspruino/src/SomeClass/FirstSubClass.litcoffee SomeClass.FirstSubClass()\n  ';
  ...
  FirstSubClass.prototype.xx = function(yy) {
    var M;
    M = '/lesspruino/src/SomeClass/FirstSubClass.litcoffee SomeClass::xx()\n  ';
    return yy = oo.vArg(M, yy, 'yy <number>', 123);
  };
...
SomeClass.FirstSubClass.xx = function(yy) {
  var M;
  M = '/lesspruino/src/SomeClass/FirstSubClass.litcoffee SomeClass.FirstSubClass.xx()\n  ';
  return yy = oo.vArg(M, yy, 'yy <number>', 123);
};
...
SomeClass.SecondSubClass = (function(superClass) {
  ...
  function SecondSubClass(config) {
    ...
    M = '/lesspruino/src/SomeClass/SecondSubClass.litcoffee SomeClass.SecondSubClass()\n  ';
  ...
  SecondSubClass.prototype.xx = function(yy) {
    var M;
    M = '/lesspruino/src/SomeClass/SecondSubClass.litcoffee SomeClass::xx()\n  ';
    return yy = oo.vArg(M, yy, 'yy <number>', 123);
  };
...
SomeClass.SecondSubClass.xx = function(yy) {
  var M;
  M = '/lesspruino/src/SomeClass/SecondSubClass.litcoffee SomeClass.SecondSubClass.xx()\n  ';
  return yy = oo.vArg(M, yy, 'yy <number>', 123);
};
...
tudor.add([
  "01 Lesspruino Constructor", tudor.is, "The class and instance are expected types", function() {
    return [new Lesspruino];
  }, "The Lesspruino class is a function", oo.F, function() {
    return Lesspruino;
  }, "`new` returns an object", oo.O, function(lesspruino) {
    return lesspruino;
  }, tudor.equal, "`Lesspruino::C` is 'Lesspruino'", 'Lesspruino', function(lesspruino) {
    return lesspruino.C;
  }, "`Lesspruino::toString()` is '[object Lesspruino]'", '[object Lesspruino]', function(lesspruino) {
    return lesspruino + '';
  }, "Instance properties as expected", tudor.equal, "`Lesspruino::x` is the number `123`", 123, function(lesspruino) {
    return lesspruino.x;
  }, "`Lesspruino::_x` is private, and is null", null, function(lesspruino) {
    return lesspruino[oo._]._x;
  }
]);

if (oo.ROBUSTABLE) {
  tudor.add([
    "91 Robust Lesspruino Constructor (for modern UAs)", tudor.is, "Class members are immutable in modern UAs", function() {
      return [new Lesspruino];
    }, "Cannot add a property to the Lesspruino class", oo.U, function() {
      Lesspruino.nope = 123;
      return Lesspruino.nope;
    }, "Cannot add a property to the Lesspruino class’s prototype object", oo.U, function(lesspruino) {
      Lesspruino.prototype.nope = 456;
      return lesspruino.nope;
    }, tudor.equal, "`Lesspruino::C` is a constant", 'Lesspruino', function(lesspruino) {
      lesspruino.C = 'changed!';
      return lesspruino.C;
    }
  ]);
}
